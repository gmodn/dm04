...
public class InventoryBar : Panel
{
	...
	public void ProcessClientInput( InputBuilder input )
	{
		...
		var sortedWeapons = Weapons.OrderBy( x => x ).ToList();
	...
	int SlotPressInput( InputBuilder input, int SelectedIndex, List<BaseDmWeapon> sortedWeapons )
	{
		var columninput = -1;
	...
	int NextInBucket( List<BaseDmWeapon> sortedWeapons )
	{
