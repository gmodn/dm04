...
{
	[Library]
	public partial class DM04WalkController : BasePlayerController
	{
		...
		//TODO: Make autojump toggleable

		public Duck Duck;
		public Unstuck Unstuck;


		public DM04WalkController()
		{
			Duck = new Duck( this );
		...
		public override void Simulate()
		{
            ...
            */
			...
			if ( Debug )
			{
				...
				///cant be bothered fixing this + its not important to get the gamemode running//DebugOverlay.ScreenText( lineOffset + 0, $"        Position: {Position}" );
