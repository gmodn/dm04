...
public partial class HLDMWalkController : BasePlayerController
{
	...
	public float sv_sprintspeed { get; set; } = 320.0f;
	public float sv_walkspeed { get; set; } = 150.0f;
	public float sv_defaultspeed { get; set; } = 320.0f;
	public float sv_airaccelerate { get; set; } = 10;


	public static bool sv_use_sbox_movehelper { get; set; } = true;
	public static bool sv_enablebunnyhopping { get; set; } = true;
	public static bool sv_autojump { get; set; } = true;
	...
	{
		base.FrameSimulate();
		EyeRotation = (Pawn as DeathmatchPlayer).ViewAngles.ToRotation();
	...
	public override void Simulate()
	{
		...
		GetWishSpeed();
		(Pawn as DeathmatchPlayer).WishVelocity = WishVelocity;
	...
	{
		Rotation a = (Pawn as DeathmatchPlayer).ViewAngles.ToRotation();
	...
	public virtual void CheckLadder()
	{
		...
		var a = (Pawn as DeathmatchPlayer).ViewAngles.ToRotation();
		if ( Client.IsUsingVr ) a = Input.VR.Head.Rotation;
